...
//            Stream<AddValueRecord> hcOpers = Stream.of(new AddValueRecord(1, 2, 3));
...
//            String argLine = scannerSupplier.get();
        ...
        // NOTE: The Supplier/Generator model is too simplified to front an i/o stream. There
        //       is no way to handle the EOF. Generators are for things like random number streams
